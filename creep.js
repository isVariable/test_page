...
function myFunc() {
    ...
    document.querySelector('#fonts').innerHTML = `${window.FINGERPRINT.fonts.fontFaceLoadFonts}`;
    document.querySelector('#images').innerHTML = `${hashMini(window.FINGERPRINT.canvasWebgl.dataURI)}`;
    document.querySelector('#pixels').innerHTML = `${hashMini(window.FINGERPRINT.canvasWebgl.pixels)}`
